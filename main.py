...
# --- Configuration ---
YOUR_API_KEY = os.getenv("API_KEY")  # Replace with your actual API key
...
# Audio Configuration
FRAMES_PER_BUFFER = 1024  # 50ms of audio (0.05s * 16000Hz)
SAMPLE_RATE = 16000
CHANNELS = 1
...
def on_open(ws):
    ...
    # 1) *** Start message ***
    start_msg = {"type": "Start", "sample_rate": SAMPLE_RATE}
